<template>
  ...
  <div>
    ...
    <div class="flex items-center gap-4">
        ...
        <div class="hidden md:flex gap-1 mr-2" v-if="currentUser && currentUser.role === 'user'">
        ...
        <div class="hidden md:flex gap-2 mr-4" v-if="currentUser && currentUser.role === 'admin'">
        ...
        <div class="relative group pl-4 border-l border-gray-200 dark:border-gray-700" v-if="currentUser">
