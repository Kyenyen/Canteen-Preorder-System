  ...
  >
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl max-w-sm w-full p-6 transform transition-all scale-100">
      ...
      <div class="flex gap-3">
        <button
          @click="cancel"
          class="w-full bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-200 font-bold py-3 rounded-xl border border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-600 transition"
        >
          Cancel
        </button>
        <button
...
function confirm() {
  // emit event to parent or call a function
  // example: emit('confirm')
  closeModal()
}
</script>
