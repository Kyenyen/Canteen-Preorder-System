...
<head>
    ...
    <style>
        body { background-color: #f4f7f9; margin: 0; padding: 0; font-family: 'Inter', -apple-system, sans-serif; }
        ...
        .header { padding: 32px 0 20px 0; text-align: center; }
        .logo-icon { background-color: #fff7ed; color: #f97316; width: 50px; height: 50px; line-height: 50px; border-radius: 50%; display: inline-block; font-size: 24px; margin-bottom: 12px; }
        h1 { color: #111827; font-size: 22px; font-weight: 700; margin: 0; }
    ...
    <table class="wrapper" role="presentation" cellpadding="0" cellspacing="0" border="0">
        <tr>
            <td align="center">
                <table class="main" role="presentation" cellpadding="0" cellspacing="0" border="0">
                    <tr>
                        <td class="header">
                            ...
                            <p style="color: #6b7280; font-size: 14px;">Thank you for dining with UniCanteen</p>
                        </td>
                    </tr>
                ...
                <div class="footer">
                    <p>&copy; {{ date('Y') }} UniCanteen &bull; TAR UMT<br>Please show this email at the counter to collect your meal.</p>
                </div>
            </td>
        </tr>
    </table>
